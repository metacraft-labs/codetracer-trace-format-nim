...
proc test_multi_stream_writer_integration() {.raises: [].} =
  ...
  doAssert c1.args[0].value == "42".toBytes, "call1 arg0"
  doAssert c1.args[1].value == "10".toBytes, "call1 arg1"
  ...
  doAssert c2.args[0].value == "10".toBytes, "call2 arg0"
  doAssert c2.args[1].value == "0".toBytes, "call2 arg1"
